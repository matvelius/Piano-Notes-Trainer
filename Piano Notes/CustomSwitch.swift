...
public class CustomSwitch: UIControl {
    ...
    @IBInspectable  public var onTintColor: UIColor = UIColor(red:0.50, green:0.96, blue:0.00, alpha:1.0) {
        didSet {
            self.setupUI()
        }
    }
    
    @IBInspectable public var offTintColor: UIColor = UIColor(red:0.19, green:0.44, blue:0.99, alpha:1.0) {
        didSet {
            self.setupUI()
        }
    }
...
extension CustomSwitch {
    ...
    fileprivate func setupLabels() {
        ...
        self.labelOn.frame = CGRect(x: 0, y: 0, width: labelWidth, height: self.frame.height)
        self.labelOff.frame = CGRect(x: self.frame.width - labelWidth, y: 0, width: labelWidth, height: self.frame.height)
        self.labelOn.font = UIFont.boldSystemFont(ofSize: 18)
        self.labelOff.font = UIFont.boldSystemFont(ofSize: 18)
        self.labelOn.textColor = UIColor.white
        self.labelOff.textColor = UIColor.white
        
        self.labelOff.sizeToFit()
        self.labelOff.text = "A"
        self.labelOn.text = "B"
